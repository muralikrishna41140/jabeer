![Portfolio Preview](https://github.com/jabeer/3D-interactive-portfolio/blob/main/public/assets/seo/og-image.png?raw=true)

# 🚀 Jabeer's Portfolio Website
...
### Live preview: https://www.jabeer.com/

![Preview](https://github.com/jabeer/3D-interactive-portfolio/blob/main/public/assets/preview_video.gif?raw=true)

https://github.com/jabeer/3D-interactive-portfolio/blob/main/preview_video.mp4
...
1. Clone this repository:
   ```bash
   git clone https://github.com/jabeer/3D-interactive-portfolio.git
   ```
...
This project is deployed using **Vercel** for its blazing-fast performance and ease of use. You can view the live site [here](https://www.jabeer.com/).
...
- **LinkedIn:** [Jabeer's LinkedIn Profile](https://www.linkedin.com/in/jabeer/)
